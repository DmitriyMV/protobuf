...
// source: theila/tester/tester.proto
...
type TestRequest struct {
	...
	Something map[string]bool `protobuf:"bytes,1,rep,name=something,proto3" json:"something,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *TestRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Something == nil {
				m.Something = make(map[string]bool)
			}
			var mapkey string
			var mapvalue bool
			for iNdEx < postIndex {
